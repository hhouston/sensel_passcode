...
def checkCoords(coordsX, coordsY):
    print("coordsX: ", coordsX);
    print("coordsY: ", coordsY);

    x = math.floor(coordsX / 75.66)
    y = math.floor(coordsY / 42.33)
    ...
    # if coordsX < 75.66 and coordsY < 42.33:
    #     print ("one");
    # else if coordsX > 75.66 and coordsY < 42.33 and coordsX < 151.33:
    #     print ("2");
    # else if coordsX > 75.66 and coordsY > 42.33 and coordsX < 151.33 and coordsY < 84.66:
